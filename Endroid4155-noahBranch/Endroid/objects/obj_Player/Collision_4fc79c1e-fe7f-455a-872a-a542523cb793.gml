...
if(damageTemp == false){
	...
	if(!knockback){
		health -= obj_slimeBlast.damage;//this might be an issue if the player slashes before knockback is over
	}
